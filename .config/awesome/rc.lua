...
globalkeys = gears.table.join(
  ...
  awful.key({}, "Print", function () awful.util.spawn_with_shell("scrot 'scrot_%Y-%m-%d_%X.png' -e 'mv $f ~/Pictures/'") end),
  awful.key({"Control"}, "Print", function () awful.util.spawn_with_shell("scrot -u 'scrot_%Y-%m-%d_%X.png' -e 'mv $f ~/Pictures/'") end),
  awful.key({"Shift"}, "Print", function () awful.util.spawn_with_shell("flameshot gui") end),
...
awful.rules.rules = {
  ...
  { rule = { },
    properties = { border_width = beautiful.border_width,
      ...
      buttons = clientbuttons,
      screen = awful.screen.preferred,
      placement = awful.placement.centered --will center float window
